...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2b0525eddcf8, const void *arg_0x2b0525edc020);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x2b0525f5e618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2b052619f8e8), 
int (*key_eq_fn)(void *arg_0x2b052619e0c8, void *arg_0x2b052619e368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b05263af610, int arg_0x2b05263af878);
static double RandomUniform(void );
...
typedef TMilli DisseminateC$MilliTimer$precision_tag;
...
static void DisseminateC$AMControl$startDone(error_t error);
#line 138
static void DisseminateC$AMControl$stopDone(error_t error);
# 60 "/usr/src/tinyos/tos/interfaces/Boot.nc"
static void DisseminateC$Boot$booted(void );
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static void DisseminateC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void DisseminateC$MilliTimer$fired(void );
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static error_t /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 104 "/usr/src/tinyos/tos/interfaces/SplitControl.nc"
static error_t DisseminateC$AMControl$start(void );
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static error_t DisseminateC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
DisseminateC$Packet$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 52 "/usr/src/tinyos/tos/interfaces/Random.nc"
static uint16_t DisseminateC$Random$rand16(void );
# 73 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
static void DisseminateC$MilliTimer$startOneShot(uint32_t dt);
# 18 "DisseminateC.nc"
message_t DisseminateC$packet[1000];
uint32_t DisseminateC$back_off[1000];
uint8_t DisseminateC$trans_count[1000];
uint8_t DisseminateC$trans_limit[1000];
radio_count_msg_t DisseminateC$known_msg[1000];


bool DisseminateC$locked[1000];


static uint32_t DisseminateC$getTimeOut(void );





static inline void DisseminateC$Boot$booted(void );




static inline void DisseminateC$AMControl$startDone(error_t err);
#line 51
static inline void DisseminateC$AMControl$stopDone(error_t err);



static inline void DisseminateC$MilliTimer$fired(void );
#line 87
static inline message_t *DisseminateC$Receive$receive(message_t *bufPtr, void *payload, uint8_t len);
#line 107
static inline void DisseminateC$AMSend$sendDone(message_t *bufPtr, error_t error);
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static void /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/usr/src/tinyos/tos/interfaces/Send.nc"
static error_t /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
...
# 73 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void DisseminateC$MilliTimer$startOneShot(uint32_t dt){
#line 73
...
#line 95
      sim_log_debug(150U, "DisseminateC", "%s RCV %i %i\n", sim_time_string(), TOS_NODE_ID, __nesc_ntoh_uint16(rcm->msg_data.nxdata));

      __nesc_hton_uint16(DisseminateC$known_msg[sim_node()].msg_data.nxdata, __nesc_ntoh_uint16(rcm->msg_data.nxdata));
      if (DisseminateC$trans_count[sim_node()] == 0) {
          DisseminateC$MilliTimer$startOneShot(DisseminateC$getTimeOut());
        }
      return bufPtr;
    }
}
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2b05267a3340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b05267a3340) {
#line 78
    case 6:
#line 78
      __nesc_result = DisseminateC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2b05267a3340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 52 "/usr/src/tinyos/tos/interfaces/Random.nc"
inline static uint16_t DisseminateC$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2b05267a1020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2b05267a1020, msg, payload, len);
#line 78
...
# 104 "/usr/src/tinyos/tos/interfaces/SplitControl.nc"
inline static error_t DisseminateC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 39
{
  if (err == SUCCESS) {
      if (TOS_NODE_ID == 1) {
          DisseminateC$MilliTimer$startOneShot(DisseminateC$getTimeOut());
          __nesc_hton_uint16(DisseminateC$known_msg[sim_node()].msg_data.nxdata, TOS_NODE_ID);
        }
    }
  else {
      DisseminateC$AMControl$start();
    }
}
...
#line 113
  DisseminateC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  DisseminateC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2b05267a4220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2b05267a4220, msg, error);
#line 110
}
#line 110
...
#line 107
{
  if (&DisseminateC$packet[sim_node()] == bufPtr) {
      DisseminateC$locked[sim_node()] = FALSE;
      DisseminateC$trans_count[sim_node()]++;
    }
}

# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static void /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  DisseminateC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/usr/src/tinyos/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2b05269d9788, message_t * msg, error_t error){
#line 100
  switch (arg_0x2b05269d9788) {
#line 100
    case 0U:
#line 100
      /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2b05269d9788, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2b05264b0020){
#line 75
  switch (arg_0x2b05264b0020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2b05264b0020);
#line 75
      break;
#line 75
    }
...
#line 75
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2b05269d8960, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2b05269d8960, addr, msg, len);
#line 80
...
# 75 "/usr/src/tinyos/tos/interfaces/Send.nc"
inline static error_t /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/usr/src/tinyos/tos/interfaces/AMPacket.nc"
inline static void /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static error_t DisseminateC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*DisseminateAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/usr/src/tinyos/tos/interfaces/Packet.nc"
inline static void * DisseminateC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 55
{
  ...
  if (DisseminateC$trans_count[sim_node()] < DisseminateC$trans_limit[sim_node()]) {


      if (DisseminateC$locked[sim_node()]) {
          return;
        }
      else {

          radio_count_msg_t *rcm = (radio_count_msg_t *)DisseminateC$Packet$getPayload(&DisseminateC$packet[sim_node()], sizeof(radio_count_msg_t ));
          ...
          __nesc_hton_uint16(rcm->msg_data.nxdata, __nesc_ntoh_uint16(DisseminateC$known_msg[sim_node()].msg_data.nxdata));


          if (DisseminateC$AMSend$send(AM_BROADCAST_ADDR, &DisseminateC$packet[sim_node()], sizeof(radio_count_msg_t )) == SUCCESS) {
              sim_log_debug(149U, "DisseminateC", "%s SND %i\n", sim_time_string(), TOS_NODE_ID);
              DisseminateC$locked[sim_node()] = TRUE;
            }

          DisseminateC$back_off[sim_node()] = DisseminateC$back_off[sim_node()] * 10;
          DisseminateC$MilliTimer$startOneShot(DisseminateC$getTimeOut());
        }
    }
}
...
# 83 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2b0526c83c28){
#line 83
  switch (arg_0x2b0526c83c28) {
#line 83
    case 0U:
#line 83
      DisseminateC$MilliTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2b0526c83c28);
#line 83
      break;
#line 83
    }
...
#line 28
{
  uint16_t rand_16 = DisseminateC$Random$rand16();
  double my_rand = rand_16 / pow(2, 16);

#line 31
  return (uint32_t )(DisseminateC$back_off[sim_node()] / 2 + DisseminateC$back_off[sim_node()] / 2 * my_rand);
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module DisseminateC */
  if (!strcmp(varname, "DisseminateC$packet"))
  {
    *addr = (uintptr_t)&DisseminateC$packet[__nesc_mote];
    *size = sizeof(DisseminateC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "DisseminateC$back_off"))
  {
    *addr = (uintptr_t)&DisseminateC$back_off[__nesc_mote];
    *size = sizeof(DisseminateC$back_off[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "DisseminateC$trans_count"))
  {
    *addr = (uintptr_t)&DisseminateC$trans_count[__nesc_mote];
    *size = sizeof(DisseminateC$trans_count[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "DisseminateC$trans_limit"))
  {
    *addr = (uintptr_t)&DisseminateC$trans_limit[__nesc_mote];
    *size = sizeof(DisseminateC$trans_limit[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "DisseminateC$known_msg"))
  {
    *addr = (uintptr_t)&DisseminateC$known_msg[__nesc_mote];
    *size = sizeof(DisseminateC$known_msg[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "DisseminateC$locked"))
  {
    *addr = (uintptr_t)&DisseminateC$locked[__nesc_mote];
    *size = sizeof(DisseminateC$locked[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module DisseminateC */
  memset((void *)&DisseminateC$packet[__nesc_mote], 0, sizeof DisseminateC$packet[__nesc_mote]);
  DisseminateC$back_off[__nesc_mote] = 100;
  DisseminateC$trans_count[__nesc_mote] = 0;
  DisseminateC$trans_limit[__nesc_mote] = 3;
  memset((void *)&DisseminateC$known_msg[__nesc_mote], 0, sizeof DisseminateC$known_msg[__nesc_mote]);
  memset((void *)&DisseminateC$locked[__nesc_mote], 0, sizeof DisseminateC$locked[__nesc_mote]);
