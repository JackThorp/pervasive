...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2b1b9b144cf8, const void *arg_0x2b1b9b143020);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x2b1b9b1c5618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2b1b9b4068e8), 
int (*key_eq_fn)(void *arg_0x2b1b9b4050c8, void *arg_0x2b1b9b405368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b1b9b616610, int arg_0x2b1b9b616878);
static double RandomUniform(void );
...
typedef TMilli TrickleC$IntervalTimer$precision_tag;
typedef TMilli TrickleC$TransmitTimer$precision_tag;
...
static void TrickleC$AMControl$startDone(error_t error);
#line 138
static void TrickleC$AMControl$stopDone(error_t error);
# 60 "/usr/src/tinyos/tos/interfaces/Boot.nc"
static void TrickleC$Boot$booted(void );
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static void TrickleC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void TrickleC$IntervalTimer$fired(void );
#line 83
static void TrickleC$TransmitTimer$fired(void );
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static error_t /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 104 "/usr/src/tinyos/tos/interfaces/SplitControl.nc"
static error_t TrickleC$AMControl$start(void );
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static error_t TrickleC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 46 "/usr/src/tinyos/tos/interfaces/Random.nc"
static uint32_t TrickleC$Random$rand32(void );
# 73 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
static void TrickleC$IntervalTimer$startOneShot(uint32_t dt);
#line 73
static void TrickleC$TransmitTimer$startOneShot(uint32_t dt);
# 19 "TrickleC.nc"
message_t TrickleC$packet[1000];
uint16_t TrickleC$counter[1000];
uint32_t TrickleC$Imin[1000];
uint8_t TrickleC$Imax[1000];
uint32_t TrickleC$time_out[1000];
uint32_t TrickleC$cur_interval[1000];
uint8_t TrickleC$REDUNDANCY[1000];

radio_count_msg_t TrickleC$known_msg[1000];



bool TrickleC$locked[1000];

static uint32_t TrickleC$getNewTimeOut(void );





static inline void TrickleC$Boot$booted(void );




static inline void TrickleC$AMControl$startDone(error_t err);
#line 63
static inline void TrickleC$AMControl$stopDone(error_t err);



static inline void TrickleC$TransmitTimer$fired(void );
#line 99
static inline void TrickleC$IntervalTimer$fired(void );
...
static inline message_t *TrickleC$Receive$receive(message_t *bufPtr, void *payload, uint8_t len);
#line 144
static inline void TrickleC$AMSend$sendDone(message_t *bufPtr, error_t error);
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static void /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/usr/src/tinyos/tos/interfaces/Send.nc"
static error_t /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
...
# 73 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void TrickleC$TransmitTimer$startOneShot(uint32_t dt){
#line 73
...
#line 118
      sim_log_debug(151U, "TrickleC", "%s RCV %i %i\n", sim_time_string(), TOS_NODE_ID, __nesc_ntoh_uint16(rcm->msg_data.nxdata));




      if (__nesc_ntoh_uint16(TrickleC$known_msg[sim_node()].version.nxdata) != __nesc_ntoh_uint16(rcm->version.nxdata) && TrickleC$cur_interval[sim_node()] != TrickleC$Imin[sim_node()]) {
          if (__nesc_ntoh_uint16(TrickleC$known_msg[sim_node()].version.nxdata) < __nesc_ntoh_uint16(rcm->version.nxdata)) {
              __nesc_hton_uint16(TrickleC$known_msg[sim_node()].version.nxdata, __nesc_ntoh_uint16(rcm->version.nxdata));
              __nesc_hton_uint16(TrickleC$known_msg[sim_node()].msg_data.nxdata, __nesc_ntoh_uint16(rcm->msg_data.nxdata));
            }
          TrickleC$counter[sim_node()] = 0;
          TrickleC$cur_interval[sim_node()] = TrickleC$Imin[sim_node()];
          TrickleC$time_out[sim_node()] = TrickleC$getNewTimeOut();
          TrickleC$TransmitTimer$startOneShot(TrickleC$time_out[sim_node()]);
          TrickleC$IntervalTimer$startOneShot(TrickleC$cur_interval[sim_node()]);
        }
      else {
        if (__nesc_ntoh_uint16(TrickleC$known_msg[sim_node()].version.nxdata) == __nesc_ntoh_uint16(rcm->version.nxdata)) {
            TrickleC$counter[sim_node()]++;
          }
        }
#line 138
      return bufPtr;
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2b1b9ba0a340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b1b9ba0a340) {
#line 78
    case 6:
#line 78
      __nesc_result = TrickleC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2b1b9ba0a340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 46 "/usr/src/tinyos/tos/interfaces/Random.nc"
inline static uint32_t TrickleC$Random$rand32(void ){
#line 46
  unsigned int __nesc_result;
#line 46
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2b1b9ba08020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2b1b9ba08020, msg, payload, len);
#line 78
...
# 104 "/usr/src/tinyos/tos/interfaces/SplitControl.nc"
inline static error_t TrickleC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
{
  if (err == SUCCESS) {
      __nesc_hton_uint16(TrickleC$known_msg[sim_node()].version.nxdata, 0);
      __nesc_hton_uint16(TrickleC$known_msg[sim_node()].msg_data.nxdata, 0);

      TrickleC$time_out[sim_node()] = TrickleC$getNewTimeOut();
      if (TOS_NODE_ID == 1) {
          __nesc_hton_uint16(TrickleC$known_msg[sim_node()].version.nxdata, 1);
          __nesc_hton_uint16(TrickleC$known_msg[sim_node()].msg_data.nxdata, TOS_NODE_ID);
        }

      sim_log_debug(149U, "TrickleC", "timeout value is %u \n", TrickleC$time_out[sim_node()]);
      TrickleC$TransmitTimer$startOneShot(TrickleC$time_out[sim_node()]);
    }
  else {
      TrickleC$AMControl$start();
    }
}
...
#line 113
  TrickleC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  TrickleC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2b1b9ba0b220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2b1b9ba0b220, msg, error);
#line 110
}
#line 110
...
#line 144
{
  if (&TrickleC$packet[sim_node()] == bufPtr) {
      TrickleC$locked[sim_node()] = FALSE;
    }
}

# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static void /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  TrickleC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/usr/src/tinyos/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2b1b9bc66318, message_t * msg, error_t error){
#line 100
  switch (arg_0x2b1b9bc66318) {
#line 100
    case 0U:
#line 100
      /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2b1b9bc66318, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2b1b9b717020){
#line 75
  switch (arg_0x2b1b9b717020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2b1b9b717020);
#line 75
      break;
#line 75
    }
...
#line 75
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2b1b9bc65488, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2b1b9bc65488, addr, msg, len);
#line 80
...
# 75 "/usr/src/tinyos/tos/interfaces/Send.nc"
inline static error_t /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/usr/src/tinyos/tos/interfaces/AMPacket.nc"
inline static void /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static error_t TrickleC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*TrickleAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/usr/src/tinyos/tos/interfaces/Packet.nc"
inline static void * TrickleC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 67
{
  ...
  if (TrickleC$locked[sim_node()] || __nesc_ntoh_uint16(TrickleC$known_msg[sim_node()].version.nxdata) == 0) {
      return;
    }
  else {
#line 73
    if (TrickleC$counter[sim_node()] < TrickleC$REDUNDANCY[sim_node()]) {



        radio_count_msg_t *rcm = (radio_count_msg_t *)TrickleC$Packet$getPayload(&TrickleC$packet[sim_node()], sizeof(radio_count_msg_t ));
        ...
        __nesc_hton_uint16(rcm->msg_data.nxdata, __nesc_ntoh_uint16(TrickleC$known_msg[sim_node()].msg_data.nxdata));
        __nesc_hton_uint16(rcm->version.nxdata, __nesc_ntoh_uint16(TrickleC$known_msg[sim_node()].version.nxdata));


        if (TrickleC$AMSend$send(AM_BROADCAST_ADDR, &TrickleC$packet[sim_node()], sizeof(radio_count_msg_t )) == SUCCESS) {
            sim_log_debug(150U, "TrickleC", "%s SND %i\n", sim_time_string(), TOS_NODE_ID);
            TrickleC$locked[sim_node()] = TRUE;
          }
      }
    }
}
...
#line 99
{
  ...
  TrickleC$cur_interval[sim_node()] = TrickleC$cur_interval[sim_node()] * 2;
  if (TrickleC$cur_interval[sim_node()] > (TrickleC$Imax[sim_node()] ^ 2 * TrickleC$Imin[sim_node()])) {
      TrickleC$cur_interval[sim_node()] = TrickleC$Imax[sim_node()];
    }
  TrickleC$time_out[sim_node()] = TrickleC$getNewTimeOut();
  TrickleC$IntervalTimer$startOneShot(TrickleC$cur_interval[sim_node()]);
  TrickleC$TransmitTimer$startOneShot(TrickleC$time_out[sim_node()]);
...
# 83 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2b1b9bedac28){
#line 83
  switch (arg_0x2b1b9bedac28) {
#line 83
    case 0U:
#line 83
      TrickleC$IntervalTimer$fired();
#line 83
      TrickleC$TransmitTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2b1b9bedac28);
#line 83
      break;
#line 83
    }
...
#line 67
# 230 "/usr/src/tinyos/tos/lib/tossim/CpmModelC.nc"
static inline double CpmModelC$prr_estimate_from_snr(double SNR)
#line 230
{
...
#line 33
{
  uint16_t rand_16 = TrickleC$Random$rand32();
  double my_rand = rand_16 / pow(2, 16);

#line 36
  return (uint32_t )(TrickleC$cur_interval[sim_node()] / 2 + TrickleC$cur_interval[sim_node()] / 2 * my_rand);
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module TrickleC */
  if (!strcmp(varname, "TrickleC$packet"))
  {
    *addr = (uintptr_t)&TrickleC$packet[__nesc_mote];
    *size = sizeof(TrickleC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TrickleC$counter"))
  {
    *addr = (uintptr_t)&TrickleC$counter[__nesc_mote];
    *size = sizeof(TrickleC$counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TrickleC$Imin"))
  {
    *addr = (uintptr_t)&TrickleC$Imin[__nesc_mote];
    *size = sizeof(TrickleC$Imin[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TrickleC$Imax"))
  {
    *addr = (uintptr_t)&TrickleC$Imax[__nesc_mote];
    *size = sizeof(TrickleC$Imax[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TrickleC$time_out"))
  {
    *addr = (uintptr_t)&TrickleC$time_out[__nesc_mote];
    *size = sizeof(TrickleC$time_out[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TrickleC$cur_interval"))
  {
    *addr = (uintptr_t)&TrickleC$cur_interval[__nesc_mote];
    *size = sizeof(TrickleC$cur_interval[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TrickleC$REDUNDANCY"))
  {
    *addr = (uintptr_t)&TrickleC$REDUNDANCY[__nesc_mote];
    *size = sizeof(TrickleC$REDUNDANCY[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TrickleC$known_msg"))
  {
    *addr = (uintptr_t)&TrickleC$known_msg[__nesc_mote];
    *size = sizeof(TrickleC$known_msg[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TrickleC$locked"))
  {
    *addr = (uintptr_t)&TrickleC$locked[__nesc_mote];
    *size = sizeof(TrickleC$locked[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module TrickleC */
  memset((void *)&TrickleC$packet[__nesc_mote], 0, sizeof TrickleC$packet[__nesc_mote]);
  TrickleC$counter[__nesc_mote] = 0;
  TrickleC$Imin[__nesc_mote] = 500;
  TrickleC$Imax[__nesc_mote] = 16;
  TrickleC$time_out[__nesc_mote] = 0;
  TrickleC$cur_interval[__nesc_mote] = 500;
  TrickleC$REDUNDANCY[__nesc_mote] = 3;
  memset((void *)&TrickleC$known_msg[__nesc_mote], 0, sizeof TrickleC$known_msg[__nesc_mote]);
  memset((void *)&TrickleC$locked[__nesc_mote], 0, sizeof TrickleC$locked[__nesc_mote]);
