...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2ac1826f4cf8, const void *arg_0x2ac1826f3020);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x2ac182775618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2ac1829b68e8), 
int (*key_eq_fn)(void *arg_0x2ac1829b50c8, void *arg_0x2ac1829b5368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2ac182bc6610, int arg_0x2ac182bc6878);
static double RandomUniform(void );
...
typedef TMilli SendMessageC$MilliTimer$precision_tag;
...
static void SendMessageC$AMControl$startDone(error_t error);
#line 138
static void SendMessageC$AMControl$stopDone(error_t error);
# 60 "/usr/src/tinyos/tos/interfaces/Boot.nc"
static void SendMessageC$Boot$booted(void );
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static void SendMessageC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void SendMessageC$MilliTimer$fired(void );
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static error_t /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 104 "/usr/src/tinyos/tos/interfaces/SplitControl.nc"
static error_t SendMessageC$AMControl$start(void );
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static error_t SendMessageC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
SendMessageC$Packet$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 64 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
static void SendMessageC$MilliTimer$startPeriodic(uint32_t dt);
# 16 "SendMessageC.nc"
message_t SendMessageC$packet[1000];

bool SendMessageC$locked[1000];
uint16_t SendMessageC$counter[1000];

static inline void SendMessageC$Boot$booted(void );




static inline void SendMessageC$AMControl$startDone(error_t err);
...
static inline void SendMessageC$AMControl$stopDone(error_t err);



static inline void SendMessageC$MilliTimer$fired(void );
#line 72
static inline message_t *SendMessageC$Receive$receive(message_t *bufPtr, void *payload, uint8_t len);
#line 89
static inline void SendMessageC$AMSend$sendDone(message_t *bufPtr, error_t error);
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static void /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/usr/src/tinyos/tos/interfaces/Send.nc"
static error_t /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
...
#line 72
{
  ...
  sim_log_debug(151U, "SendMessageC", "received a packet.\n");
  if (len != sizeof(radio_count_msg_t )) {
      ...
      sim_log_debug(152U, "SendMessageC", "This is %u receieving packet %hu from %u.\n", TOS_NODE_ID, __nesc_ntoh_uint16(rcm->counter.nxdata), __nesc_ntoh_uint16(rcm->sender_id.nxdata));
      return bufPtr;
    }
}
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2ac182fba340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2ac182fba340) {
#line 78
    case 6:
#line 78
      __nesc_result = SendMessageC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2ac182fba340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2ac182fb8020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2ac182fb8020, msg, payload, len);
#line 78
...
# 104 "/usr/src/tinyos/tos/interfaces/SplitControl.nc"
inline static error_t SendMessageC$AMControl$start(void ){
#line 104
...
# 64 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void SendMessageC$MilliTimer$startPeriodic(uint32_t dt){
#line 64
...
{
  if (err == SUCCESS) {
      SendMessageC$MilliTimer$startPeriodic(250);
    }
  else {
      SendMessageC$AMControl$start();
    }
}
...
#line 113
  SendMessageC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  SendMessageC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2ac182fbb220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2ac182fbb220, msg, error);
#line 110
}
#line 110
...
#line 89
{
  if (&SendMessageC$packet[sim_node()] == bufPtr) {
      SendMessageC$locked[sim_node()] = FALSE;
    }
}

# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static void /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  SendMessageC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/usr/src/tinyos/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2ac1831f7e18, message_t * msg, error_t error){
#line 100
  switch (arg_0x2ac1831f7e18) {
#line 100
    case 0U:
#line 100
      /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2ac1831f7e18, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2ac182cc7020){
#line 75
  switch (arg_0x2ac182cc7020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2ac182cc7020);
#line 75
      break;
#line 75
    }
...
#line 53
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2ac1831f5020, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2ac1831f5020, addr, msg, len);
#line 80
...
# 75 "/usr/src/tinyos/tos/interfaces/Send.nc"
inline static error_t /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/usr/src/tinyos/tos/interfaces/AMPacket.nc"
inline static void /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static error_t SendMessageC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SendMessageAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/usr/src/tinyos/tos/interfaces/Packet.nc"
inline static void * SendMessageC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 39
{
  ...
  if (TOS_NODE_ID == 1) {
      ...
      SendMessageC$counter[sim_node()]++;
      sim_log_debug(149U, "SendMessageC", "SendMessageC: timer fired, counter is %hu.\n", SendMessageC$counter[sim_node()]);


      if (SendMessageC$locked[sim_node()]) {
          return;
        }
      else {

          radio_count_msg_t *rcm = (radio_count_msg_t *)SendMessageC$Packet$getPayload(&SendMessageC$packet[sim_node()], sizeof(radio_count_msg_t ));
          ...
          __nesc_hton_uint16(rcm->counter.nxdata, SendMessageC$counter[sim_node()]);
          __nesc_hton_uint16(rcm->sender_id.nxdata, TOS_NODE_ID);


          if (SendMessageC$AMSend$send(AM_BROADCAST_ADDR, &SendMessageC$packet[sim_node()], sizeof(radio_count_msg_t )) == SUCCESS) {
              sim_log_debug(150U, "SendMessageC", "SendMessageC: packet sent.\n", SendMessageC$counter[sim_node()]);
              SendMessageC$locked[sim_node()] = TRUE;
            }
        }
    }
}
...
# 83 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2ac183460c28){
#line 83
  switch (arg_0x2ac183460c28) {
#line 83
    case 0U:
#line 83
      SendMessageC$MilliTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2ac183460c28);
#line 83
      break;
#line 83
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module SendMessageC */
  if (!strcmp(varname, "SendMessageC$packet"))
  {
    *addr = (uintptr_t)&SendMessageC$packet[__nesc_mote];
    *size = sizeof(SendMessageC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SendMessageC$locked"))
  {
    *addr = (uintptr_t)&SendMessageC$locked[__nesc_mote];
    *size = sizeof(SendMessageC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SendMessageC$counter"))
  {
    *addr = (uintptr_t)&SendMessageC$counter[__nesc_mote];
    *size = sizeof(SendMessageC$counter[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module SendMessageC */
  memset((void *)&SendMessageC$packet[__nesc_mote], 0, sizeof SendMessageC$packet[__nesc_mote]);
  memset((void *)&SendMessageC$locked[__nesc_mote], 0, sizeof SendMessageC$locked[__nesc_mote]);
  SendMessageC$counter[__nesc_mote] = 0;
